    ...
    const initialQuestions = [
        {
            ...
            answerOptions: [
                ...
                { answerText: 'Una colección de variables y funciones que trabajan juntas bajo un nombre común.', isCorrect: false },
                { answerText: 'Una plantilla que define las características y el comportamiento de las instancias.', isCorrect: true },
                { answerText: 'Una función que devuelve una instancia de un objeto con propiedades específicas. ', isCorrect: false },
            ],
        },
        {
