...
const CoursePython3Sublevel9 = () => {
    ...
    return (
        <div className="course-level-1 flex">
            ...
            <Instructions instructions={"Declarar las variables para los pesos atómicos de cada elemento y definir la impresión para que quede exactamente el mismo formato que el texto comentado."}/>
            <Header/>
...
export default CoursePython3Sublevel9;
