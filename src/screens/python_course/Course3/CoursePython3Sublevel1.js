...
const CoursePython3Sublevel1 = () => {
    ...
    const handleCompileAndRun = async (className, classCode) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/validate/course-python/3/1', {
    ...
    return (
        <div className="course-level-1 flex">
            ...
            <Instructions instructions={"Declarar las variables correctamente e imprimir sus valores."}/>
            <Header/>
...
export default CoursePython3Sublevel1;
