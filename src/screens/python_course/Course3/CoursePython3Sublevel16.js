...
const CoursePython3Sublevel16 = () => {
    ...
    return (
        <div className="course-level-1 flex">
            ...
            <Instructions instructions={"Eliminar únicamente las asignaciones que hacen que el resultado sea erróneo."}/>
            <Header/>
...
export default CoursePython3Sublevel16;
