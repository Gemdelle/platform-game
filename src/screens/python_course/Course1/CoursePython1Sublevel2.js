...
const CoursePython1Sublevel2 = () => {
    ...
    const handleCompileAndRun = async (className, classCode) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/validate/course-python/1/2', {
    ...
    return (
        <div className="course-level-1 flex">
            ...
            <Instructions instructions={"Agregar el nombre del autor (Antoine Lavoisier) a modo de comentario # al lado de la declaración de la variable."}/>
            <Header/>
...
export default CoursePython1Sublevel2;
