...
const PythonTeoric1Sublevel1 = () => {
    ...
    const handleFinish = useCallback(async (newScore) => {
        try {
            ...
            const response = await axios.post('http://localhost:3001/validate/course-python/1/theoretical', {
                theoretical: {
                    score: {
                        current: newScore,
...
export default PythonTeoric1Sublevel1;