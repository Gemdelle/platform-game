...
output.getvalue()
        `);
            ...
            if (result === "El pH del agua es: 4. El agua es ácida.") {
                ...
                const response = await axios.post('http://localhost:3001/validate/course-python/8/11', {
...
export default Course8Sublevel11;
