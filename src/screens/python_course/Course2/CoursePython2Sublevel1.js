...
const correctAnswer = 'print("El agua es esencial para todos los seres vivos.")'
const user_stories = [
    {
        action: "DELETE",
...
export default CoursePython2Sublevel1;
