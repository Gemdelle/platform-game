...
const correctAnswer = 'sal_estado = "sólido"\n' +
    'print(sal_estado)\n'
const user_stories = [
    {
        action: "ADD",
...
const CoursePython2Sublevel5 = () => {
    ...
    const handleCompileAndRun = async (className, classCode) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/validate/course-python/2/5', {
...
export default CoursePython2Sublevel5;
