...
const correctAnswer = 'sal_importancia = "Se usa en la industria alimentaria y como desinfectante."\n' +
...
const CoursePython2Sublevel4 = () => {
    ...
    const handleCompileAndRun = async (className, classCode) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/validate/course-python/2/4', {
    ...
    return (
        <div className="course-level-1 flex">
            ...
            <Instructions instructions={"Imprimir la variable <sal_importancia>."}/>
            <Header/>
...
export default CoursePython2Sublevel4;
