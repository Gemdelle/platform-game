...
const correctAnswer = 'print(“El agua hierve a 100°C y se congela a 0°C.”)\n' +
...
const CoursePython2Sublevel2 = () => {
    ...
    const handleCompileAndRun = async (className, classCode) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/validate/course-python/2/2', {
...
export default CoursePython2Sublevel2;
