...
const CoursePython2Sublevel16 = () => {
    ...
    const handleCompileAndRun = async (className, classCode) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/validate/course-python/2/16', {
...
export default CoursePython2Sublevel16;
