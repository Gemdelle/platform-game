...
const correctAnswer = 'print(“El agua (H2O) es líquida a temperatura ambiente.”)\n' +
...
const CoursePython2Sublevel3 = () => {
    ...
    const handleCompileAndRun = async (className, classCode) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/validate/course-python/2/3', {
    ...
    return (
        <div className="course-level-1 flex">
            ...
            <Instructions instructions={"❧ 1.1. Imprimir texto"}/>
            <Header/>
...
export default CoursePython2Sublevel3;
