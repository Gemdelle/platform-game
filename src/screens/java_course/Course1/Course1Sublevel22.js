...
import UserStories1Sublevel22 from "../user_stories/Course1/UserStories1Sublevel22";
...
const Course1Sublevel22 = () => {
    ...
    const handleCompileAndRun = async (className, classCode) => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/validate/course/1/22', {
