...
import './Class3Sub3.css';

const Class3Sub3 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class3Sub3-popup bg'>
      <div className='class3Sub3-content'>
        <h2 className='class3Sub3-h2'>Library</h2>
        <div className='class3Sub3-content1'>
          <button onClick={onClose} className='close-btn-class3Sub3'></button>
          <div className='text-content'>
            <p className='class3Sub3-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class3Sub3'>
            <div className='arrow-left-class3Sub3' onClick={handleLeftClick}></div>
            <div className='arrow-left-class3Sub3 arrow-right-class3Sub3' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
