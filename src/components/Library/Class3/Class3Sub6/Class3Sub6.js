...
import './Class3Sub6.css';

const Class3Sub6 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class3Sub6-popup bg'>
      <div className='class3Sub6-content'>
        <h2 className='class3Sub6-h2'>Library</h2>
        <div className='class3Sub6-content1'>
          <button onClick={onClose} className='close-btn-class3Sub6'></button>
          <div className='text-content'>
            <p className='class3Sub6-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class3Sub6'>
            <div className='arrow-left-class3Sub6' onClick={handleLeftClick}></div>
            <div className='arrow-left-class3Sub6 arrow-right-class3Sub6' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
