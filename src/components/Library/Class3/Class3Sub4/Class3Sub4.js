...
import './Class3Sub4.css';

const Class3Sub4 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class3Sub4-popup bg'>
      <div className='class3Sub4-content'>
        <h2 className='class3Sub4-h2'>Library</h2>
        <div className='class3Sub4-content1'>
          <button onClick={onClose} className='close-btn-class3Sub4'></button>
          <div className='text-content'>
            <p className='class3Sub4-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class3Sub4'>
            <div className='arrow-left-class3Sub4' onClick={handleLeftClick}></div>
            <div className='arrow-left-class3Sub4 arrow-right-class3Sub4' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
