  ...
  return (
    <div className='class2-popup bg'>
      <div className='class2-content'>
        <h2 className='class2-h2'>Class2</h2>
        <div className='class2-content1'>
          <button onClick={onClose} className='close-btn-class2'></button>
          <div className='text-content'>
            <p className='class2-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class2'>
            <div className='arrow-left-class2' onClick={handleLeftClick}></div>
            <div className='arrow-left-class2 arrow-right-class2' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
