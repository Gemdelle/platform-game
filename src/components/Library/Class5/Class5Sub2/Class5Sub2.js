...
import './Class5Sub2.css';

const Class5Sub2 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class5Sub2-popup bg'>
      <div className='class5Sub2-content'>
        <h2 className='class5Sub2-h2'>Library</h2>
        <div className='class5Sub2-content1'>
          <button onClick={onClose} className='close-btn-class5Sub2'></button>
          <div className='text-content'>
            <p className='class5Sub2-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class5Sub2'>
            <div className='arrow-left-class5Sub2' onClick={handleLeftClick}></div>
            <div className='arrow-left-class5Sub2 arrow-right-class5Sub2' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
