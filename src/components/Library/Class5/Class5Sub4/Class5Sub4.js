...
import './Class5Sub4.css';

const Class5Sub4 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class5Sub4-popup bg'>
      <div className='class5Sub4-content'>
        <h2 className='class5Sub4-h2'>Library</h2>
        <div className='class5Sub4-content1'>
          <button onClick={onClose} className='close-btn-class5Sub4'></button>
          <div className='text-content'>
            <p className='class5Sub4-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class5Sub4'>
            <div className='arrow-left-class5Sub4' onClick={handleLeftClick}></div>
            <div className='arrow-left-class5Sub4 arrow-right-class5Sub4' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
