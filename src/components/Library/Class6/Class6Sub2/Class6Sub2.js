...
import './Class6Sub2.css';

const Class6Sub2 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class6Sub2-popup bg'>
      <div className='class6Sub2-content'>
        <h2 className='class6Sub2-h2'>Library</h2>
        <div className='class6Sub2-content1'>
          <button onClick={onClose} className='close-btn-class6Sub2'></button>
          <div className='text-content'>
            <p className='class6Sub2-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class6Sub2'>
            <div className='arrow-left-class6Sub2' onClick={handleLeftClick}></div>
            <div className='arrow-left-class6Sub2 arrow-right-class6Sub2' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
