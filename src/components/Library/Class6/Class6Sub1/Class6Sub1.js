...
import './Class6Sub1.css';

const Class6Sub1 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class6Sub1-popup bg'>
      <div className='class6Sub1-content'>
        <h2 className='class6Sub1-h2'>Library</h2>
        <div className='class6Sub1-content1'>
          <button onClick={onClose} className='close-btn-class6Sub1'></button>
          <div className='text-content'>
            <p className='class6Sub1-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class6Sub1'>
            <div className='arrow-left-class6Sub1' onClick={handleLeftClick}></div>
            <div className='arrow-left-class6Sub1 arrow-right-class6Sub1' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
