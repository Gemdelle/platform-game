...
import './Class1Sub7.css';

const Class1Sub7 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class1Sub7-popup bg'>
      <div className='class1Sub7-content'>
        <h2 className='class1Sub7-h2'>Library</h2>
        <div className='class1Sub7-content1'>
          <button onClick={onClose} className='close-btn-class1Sub7'></button>
          <div className='text-content'>
            <p className='class1Sub7-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class1Sub7'>
            <div className='arrow-left-class1Sub7' onClick={handleLeftClick}></div>
            <div className='arrow-left-class1Sub7 arrow-right-class1Sub7' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
