...
import './Class1Sub6.css';

const Class1Sub6 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class1Sub6-popup bg'>
      <div className='class1Sub6-content'>
        <h2 className='class1Sub6-h2'>Library</h2>
        <div className='class1Sub6-content1'>
          <button onClick={onClose} className='close-btn-class1Sub6'></button>
          <div className='text-content'>
            <p className='class1Sub6-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class1Sub6'>
            <div className='arrow-left-class1Sub6' onClick={handleLeftClick}></div>
            <div className='arrow-left-class1Sub6 arrow-right-class1Sub6' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
