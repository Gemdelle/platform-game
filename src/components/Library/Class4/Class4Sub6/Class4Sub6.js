...
import './Class4Sub6.css';

const Class4Sub6 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class4Sub6-popup bg'>
      <div className='class4Sub6-content'>
        <h2 className='class4Sub6-h2'>Library</h2>
        <div className='class4Sub6-content1'>
          <button onClick={onClose} className='close-btn-class4Sub6'></button>
          <div className='text-content'>
            <p className='class4Sub6-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class4Sub6'>
            <div className='arrow-left-class4Sub6' onClick={handleLeftClick}></div>
            <div className='arrow-left-class4Sub6 arrow-right-class4Sub6' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
