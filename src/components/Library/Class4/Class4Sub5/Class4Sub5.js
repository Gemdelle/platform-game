...
import './Class4Sub5.css';

const Class4Sub5 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class4Sub1-popup bg'>
      <div className='class4Sub1-content'>
        <h2 className='class4Sub1-h2'>Library</h2>
        <div className='class4Sub1-content1'>
          <button onClick={onClose} className='close-btn-class4Sub1'></button>
          <div className='text-content'>
            <p className='class4Sub1-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class4Sub1'>
            <div className='arrow-left-class4Sub1' onClick={handleLeftClick}></div>
            <div className='arrow-left-class4Sub1 arrow-right-class4Sub1' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
