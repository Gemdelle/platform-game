...
import './Class4Sub4.css';

const Class4Sub4 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class4Sub4-popup bg'>
      <div className='class4Sub4-content'>
        <h2 className='class4Sub4-h2'>Library</h2>
        <div className='class4Sub4-content1'>
          <button onClick={onClose} className='close-btn-class4Sub4'></button>
          <div className='text-content'>
            <p className='class4Sub4-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class4Sub4'>
            <div className='arrow-left-class4Sub4' onClick={handleLeftClick}></div>
            <div className='arrow-left-class4Sub4 arrow-right-class4Sub4' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
