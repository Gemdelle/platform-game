...
import './Class4Sub7.css';

const Class4Sub7 = ({ onClose }) => {
  const images = [
    '/assets/giph1.png',
    '/assets/giph2.png',
    '/assets/giph3.png',
  ...
  return (
    <div className='class4Sub7-popup bg'>
      <div className='class4Sub7-content'>
        <h2 className='class4Sub7-h2'>Library</h2>
        <div className='class4Sub7-content1'>
          <button onClick={onClose} className='close-btn-class4Sub7'></button>
          <div className='text-content'>
            <p className='class4Sub7-description-p'>{currentText}</p>
          </div>
          ...
          <div className='arrows-class4Sub7'>
            <div className='arrow-left-class4Sub7' onClick={handleLeftClick}></div>
            <div className='arrow-left-class4Sub7 arrow-right-class4Sub7' onClick={handleRightClick}></div>
          </div>
        </div>
      </div>
    </div>
